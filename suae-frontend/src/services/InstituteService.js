...
// //         return axios.post("saveInstituteNotification", data);
// //     }
// //     notifications(params) {
// //         return axios.get("InstituteNotifications", { params });
// //     }
// //     allNotifications(params) {
// //         return axios.get("InstituteNotifications/ALL", { params });
// //     }
// //     unreadNotificationsCount() {
// //         return axios.get("InstituteUnreadNotificationsCount");
// //     }
// //     markNotificationRead(id) {
// //         return axios.post("markInstituteNotificationRead", { id });
// //     }
// //     deleteNotification(id) {
// //         return axios.post("deleteInstituteNotification", { id });
// //     }
// //     //Payment slips 
// //     paymentSlips = async () => {
// //         try {
...
// //                 const insId = Number(getIns?.data?.data?.institute_id || getIns?.data?.institute_id || 0);
// //                 let headers = {};
// //                 if (insId) {
// //                     try {
// //                         const { sdx } = await import('../sdx');
...
// //     }
// //     //Delete Visa API
// //     deleteVisaLetter(doc_id) {
// //         // Use reset endpoint to nullify file and treat as deleted
// //         return axios.post(`visa/doc/reset_visa`, { id: doc_id });
// //     }
...
// //     }
// //     //Upload Pickup Detail
// //     uploadPickupDetail(data) {
// //         return axios.post("pickup/upload", data);
// //     }
// //     //getPickup details 
// //     getPickupDetails(id) {
// //         return axios.post(`pickup/getdocs/${id}`);
// //     }
// //     //Delete Pickup Detail
// //     deletePickupDetail(doc_id) {
// //         return axios.post(`pickup/delete/${doc_id}`);
// //     }
...
// //         const base = 'https://sisphp.questdigiflex.in/uploads/files/';
// //         try {
