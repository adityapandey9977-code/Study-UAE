...
//         this.apiUrl = '/';
//         this.apiUrlNode = '/';
//         if (window.location.href.indexOf("sis.questdigiflex.in") >= 0) {
//             this.apiUrl = window.location.protocol + "//sisphp.questdigiflex.in/";
//             this.apiUrlNode = 'https://sisnode.questdigiflex.in/';
//         } else {
//             // eslint-disable-next-line
//             this.apiUrl = "http" + "s://" + "sisphp.questdigiflex.in" + "/";
//             this.apiUrlNode = 'https://sisnode.questdigiflex.in/';
//         }
//     }
...
//         let { token, nodetoken, name, modules, type, is_client_admin, is_admin, is_student, gender, regno, is_institute, is_agent, isAutoLoggedIn } = data;
...
//     }
//     getNodeToken = () => {
//         return window.localStorage['nodetoken'] || '';
//     }
...
//     }
//     // getModules = () => {
//     //     let m = window.localStorage['modules'];
//     //     if (m) {
//     //         return JSON.parse(m);
//     //     }
//     //     return {};
...
//     }
//     isAgent = () => {
//         return window.localStorage['is_agent'] * 1;
//     }
//     isLogged = () => {
...
//         let url = window.origin + "/login?key=" + key;
//         if (window.location.href.indexOf("studyindiascholarship.com") >= 0) {
...
class util {
    ...
    //       if (window.location.hostname === "sis.studyindiascholarship.com") {
    //     // LIVE
    //     this.apiUrl = window.location.protocol + "//php.studyindiascholarship.com/";
    ...
    constructor() {
        ...
        console.log('Using PHP API Endpoint:', this.apiUrl);
