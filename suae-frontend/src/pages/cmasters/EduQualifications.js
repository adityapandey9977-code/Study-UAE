...
export default function EduQualifications(){
    ...
    const list=(p, ps)=>{
        ...
        util.showLoader();
        CmasterService.eduQualifications(sdataRef.current).then(({data})=>{
    ...
    const deleteRecord=(id)=>{
        message.destroy();
        confirm({
            title: `Do you Want to delete this educational qualification?`,
            ...
            onOk() {
                util.showLoader();
                CmasterService.deleteEduQualification(id).then(({data})=>{
...
const AddForm=forwardRef((props, ref)=>{
    ...
    const handleOk = () => {
        message.destroy();
        util.showLoader();
        CmasterService.saveEduQualification(data).then(({data}) => {
    ...
    return (
        <Modal
            title={`${data.id ? 'Edit' : 'Add'} Educational Qualification`}
            visible={showModal}
            okText="Save"
            onOk={handleOk}
